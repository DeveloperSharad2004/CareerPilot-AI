...
const Home = () => {
    ...
    // Backend Logic ke hisab se Logout Handler
    const handleLogout = async () => {
        try {
            ...
            // Logout successful hone ke baad user ko login page par bhej rahe hain
            navigate('/login');
        } catch (error) {
    ...
    return (
        <div className='home-page'>
            ...
            {/* Page Header with Flexbox for Logout Button alignment */}
